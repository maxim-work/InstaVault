...
urlpatterns = [
    ...
    path(
        "profile/send_old_email_code/",
        views.send_old_email_code,
        name="send_old_email_code",
    ),
    path(
        "profile/verify_old_email_code/",
        views.verify_old_email_code,
        name="verify_old_email_code",
    ),
    path(
        "profile/send_new_email_code/",
        views.send_new_email_code,
        name="send_new_email_code",
    ),
    path(
        "profile/verify_new_email_code/",
        views.verify_new_email_code,
        name="verify_new_email_code",
    ),
    path("profile/update_email/", views.update_email, name="update_email"),
    path(
        "profile/get-telegram-code/",
        views.get_telegram_code,
        name="get_telegram_code",
    ),
    ...
    path(
        "change_password/send_reset_code/",
        views.send_reset_code,
        name="send_reset_code",
    ),
    path(
        "change_password/verify_reset_code/",
    ...
    path(
        "admin/confirm-ownership-transfer/",
        confirm_ownership_transfer,
        name="confirm_ownership_transfer",
    ),
    path(
        "admin/send-telegram-message/",
        send_telegram_message_view,
    ...
    path("admin/ban-operation/", ban_operation_view, name="ban_operation"),
    path("ban/appeal/", views.appeal, name="appeal"),
    path(
        "ban/check-appeal-username/",
        views.check_appeal_username,
